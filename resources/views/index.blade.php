...
<head>
    ...
    <!--====== TITLE TAG ======-->
    <title>Mega Innovator - Creating web site E-commerce and Application web and Mobile App </title>

    <!--====== FAVICON ICON =======-->
    <link rel="shortcut icon" type="image/ico" href="storage/img/favicon.png" />
...
<body data-spy="scroll" data-target=".mainmenu-area" data-offset="90">
                ...
                <nav class="navbar">
                    <div class="container">
                        <div class="navbar-header">
                            <a href="#home" class="navbar-brand"><img src="storage/img/logo.png" width="200" alt="logo"></a>
                        </div>
            ...
            <div class="row flex-v-center">
                ...
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12 hidden-sm">
                    <div class="service-image text-center wow fadeIn">
                        <img src="storage/img/service/service-mockup.png" alt="">
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
        ...
        <div class="container">
            ...
            <div class="row portfolio-list wow fadeIn">
                ...
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12 web digital portfolio-item">
                    <div class="single-portfolio white">
                        <div class="portfolio-thumb">
                            <img src="storage/img/portfolio/portfolio_4.jpg" alt="">
                        </div>
                        <div class="portfolio-details v-center">
                            <h4>Web Marketing</h4>
                            <p>Business / Service / Product / Template</p>
                ...
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12 web portfolio-item">
                    <div class="single-portfolio white">
                        <div class="portfolio-thumb">
                            <img src="storage/img/portfolio/portfolio_6.jpg" alt="">
                        </div>
                        <div class="portfolio-details v-center">
                            <h4>Web Development</h4>
                            <p>Business / Service / Product / Template</p>
                ...
                <div class="hidden-sm col-md-4 col-lg-4 col-sm-6 col-xs-12 digital portfolio-item">
                    <div class="single-portfolio white">
                        <div class="portfolio-thumb">
                            <img src="storage/img/portfolio/portfolio_9.jpg" alt="">
                        </div>
                        <div class="portfolio-details v-center">
                            <h4>Online Marketing</h4>
                            <p>Business / Service / Product / Template</p>
            ...
            <div class="row team-slider">
                    ...
                    <div class="single-team center white wow fadeIn">
                        <div class="member-top-details relative">
                            <div class="member-thumb">
                                <img src="storage/img/team/member-1.jpg" alt="">
                            </div>
                            <div class="member-details v-center">
                                <h4>TOPSMMPANEL.COM<span>Chef</span></h4>
                                <p>Lorem ipsum dolor sit amet et consectetur adipiscing elit, Ut sed do eiusmod tempor indunt ut labore et dolore magna.</p>
                            </div>
                        </div>
                ...
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                    <div class="single-team center white wow fadeIn">
                        <div class="member-top-details relative">
                            <div class="member-thumb">
                                <img src="storage/img/team/member-2.jpg" alt="">
                            </div>
                            <div class="member-details v-center">
                                <h4>TOPSMMPANEL.COM<span>Chef</span></h4>
                                <p>Lorem ipsum dolor sit amet et consectetur adipiscing elit, Ut sed do eiusmod tempor indunt ut labore et dolore magna.</p>
                ...
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                    <div class="single-team center white wow fadeIn">
                        <div class="member-top-details relative">
                            <div class="member-thumb">
                                <img src="storage/img/team/member-3.jpg" alt="">
                            </div>
                            <div class="member-details v-center">
                                <h4>TOPSMMPANEL.COM<span>Chef</span></h4>
                                <p>Lorem ipsum dolor sit amet et consectetur adipiscing elit, Ut sed do eiusmod tempor indunt ut labore et dolore magna.</p>
                ...
                <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12">
                    <div class="single-team center white wow fadeIn">
                        <div class="member-top-details relative">
                            <div class="member-thumb">
                                <img src="storage/img/team/member-4.jpg" alt="">
                            </div>
                            <div class="member-details v-center">
                                <h4>TOPSMMPANEL.COM<span>Chef</span></h4>
                                <p>Lorem ipsum dolor sit amet et consectetur adipiscing elit, Ut sed do eiusmod tempor indunt ut labore et dolore magna.</p>
    ...
    <!--INFO AREA-->
    <section class="info-area gray-bg">
        <div class="container">
            <div class="row flex-v-center">
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                    <div class="intro-image wow fadeIn">
                        <img src="storage/img/intro/intro-bg.jpg" alt="">
                    </div>
                </div>
                <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        ...
                        <div class="single-testmonial center">
                            <div class="testmonial-author-data">
                                <div class="author-image">
                                    <img src="storage/img/testmonial/testmonial-1.jpg" alt="">
                                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                    <div class="single-price center wow fadeInUp" data-wow-delay="0.2s">
                        ...
                        <div class="price-rate white">
                            <h2><span>$</span>9.99 <span>/monthly</span></h2>
                        </div>
                        ...
                        <div class="buy-now-button">
                            <a href="#" class="read-more">Buy It Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12">
                ...
                <div class="col-md-4 col-lg-4 col-sm-6 col-xs-12 visible-sm">
                    <div class="single-price center wow fadeInUp" data-wow-delay="0.5s">
                        <div class="price-hidding">
                            <h2>Basic</h2>
                            <p>The best to start</p>
                        </div>
            ...
            <div class="row">
                        ...
                        <div class="blog-list">
                            <div class="single-blog">
                                <div class="blog-thumb">
                                    <img src="storage/img/blog/blog-1.jpg" alt="">
                                </div>
                            ...
                            <div class="single-blog">
                                <div class="blog-thumb">
                                    <img src="storage/img/blog/blog-2.jpg" alt="">
                                </div>
                                <div class="blog-details">
                                    <h4><a href="#">The User Experience</a></h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam sagittis... <a href="#">Read More</a></p>
                            ...
                            <div class="single-blog">
                                <div class="blog-thumb">
                                    <img src="storage/img/blog/blog-3.jpg" alt="">
                                </div>
                                <div class="blog-details">
                                    <h4><a href="#">The User Experience</a></h4>
                                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam sagittis... <a href="#">Read More</a></p>
                ...
                <div class="hidden-md col-lg-4 col-sm-6 col-xs-12">
                    <div class="feed-widget insta-feed wow fadeIn">
                        ...
                        <ul>
                            <li>
                                <a href="#"><img src="storage/img/instagram/insta_1.jpg" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="storage/img/instagram/insta_2.jpg" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="storage/img/instagram/insta_3.jpg" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="storage/img/instagram/insta_4.jpg" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="storage/img/instagram/insta_5.jpg" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="storage/img/instagram/insta_6.jpg" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="storage/img/instagram/insta_7.jpg" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="storage/img/instagram/insta_8.jpg" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="storage/img/instagram/insta_9.jpg" alt=""></a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
                    <div class="client-slider mt50 wow fadeIn">
                        <div class="single-client">
                            <img src="storage/img/client/client-1.png" alt="">
                        </div>
                        <div class="single-client">
                            <img src="storage/img/client/client-2.png" alt="">
                        </div>
                        <div class="single-client">
                            <img src="storage/img/client/client-3.png" alt="">
                        </div>
                        <div class="single-client">
                            <img src="storage/img/client/client-4.png" alt="">
                        </div>
                        <div class="single-client">
                            <img src="storage/img/client/client-5.png" alt="">
                        </div>
                        <div class="single-client">
                            <img src="storage/img/client/client-1.png" alt="">
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                        <div class="contact-form mb50 wow fadeIn">
                            <h2>Send Message</h2>
                            <form action="{{route('send.email')}}" id="contact-form" method="post">
                                @csrf
                                <div class="form-group" id="phone-field">
                                    <div class="form-input">
                                        <input type="tel" class="form-control" id="form-phone" name="form_phone" placeholder="Phone Number.." required>
                                    </div>
                                </div>
                                <div class="form-group" id="email-field">
                                    <div class="form-input">
                                        <input type="email" class="form-control" id="form-email" name="form_email" placeholder="Email.." required>
                                    </div>
                                </div>
                                <div class="form-group" id="subject-field">
                                    <div class="form-input">
                                        <input type="text" class="form-control" id="form-subject" name="form_subject" placeholder="Subject..">
                                    </div>
                                </div>
                                <div class="form-group" id="message-field">
                                    <div class="form-input">
                                        <textarea class="form-control" rows="6" id="form-message" name="form_message" placeholder="Your Message Here..." required></textarea>
                                    </div>
                                </div>
                                <div class="form-group" id="message-field">
                                    <div class="form-input">
    ...
    <script>
        ...
        formEmail.form_phone.onkeydown = ($event) => {
